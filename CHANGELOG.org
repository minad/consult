...
- Abbreviated directories and project names are propertized with the full path
  as =help-echo=. Enable =tooltip-mode= and move the mouse over the prompt to see.
