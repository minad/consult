...
- Add =consult--source-project-root=, a =consult-buffer= source for root directories
  of known projects.
- Introduce generalized =consult-project-function=, deprecate
  ...
  retrieve the project directories and is preconfigured with a default function,
