...
- Deprecate =consult-*-command= configuration variables in favor of =consult-*config=.
  The variables have been renamed since the configuration format changed. The new
