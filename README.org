 ...
 *NOTE:* Consult supports fine-grained customization of individual commands. This
 ...
 If you want to dynamically adjust values at runtime you can use =:eval=. This works
 only for commands, not for sources.

 #+begin_src emacs-lisp
   (defalias 'consult-line-thing-at-point 'consult-line)
   (consult-customize
    consult-line-thing-at-point :initial (:eval (thing-at-point 'symbol)))
 #+end_src
 ...
 2. Use =consult-customize= with =:eval= to change a command setting.
 3. Create your own wrapper function which passes modified arguments to the Consult functions.
 4. Create your own buffer [[#multiple-sources][multi sources]] for =consult-buffer=.
 5. Create advices to modify some internal behavior.
 6. Write or propose a patch.
...
- [[https://github.com/mohkale/consult-bibtex][consult-bibtex]]: Consult interface for bibliographies.
- [[https://github.com/mohkale/consult-yasnippet][consult-company]]: Completion at point using the company backends.
...
- [[https://github.com/bdarcus/bibtex-actions][bibtex-actions]]: Versatile frontend for bibliographies, frontend agnostic.
...
- [[https://github.com/mohkale][Mohsin Kaleem]] ([[https://github.com/mohkale/consult-bibtex][consult-bibtex]], [[https://github.com/mohkale/consult-company][consult-company]], [[https://github.com/mohkale/consult-eglot][consult-eglot]], [[https://github.com/mohkale/consult-yasnippet][consult-yasnippet]])
