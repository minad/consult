...
** Virtual Buffers
 ...
 - =consult-buffer= (=-other-window=, =-other-frame=): Enhanced version
   ...
   - Arbitrary [[#multiple-sources][other sources]] can be configured via =consult-buffer-sources=.x
...
** Miscellaneous
 ...
 - =consult-completion-in-region=: This function can be set as
   ...
   completions directly in the buffer as a small popup. In that case, I recommed
   either the [[https://github.com/minad/corfu][Corfu]] or the [[https://github.com/company-mode/company-mode][Company]] package.
