...
** Editing
 ...
 - =consult-yank-from-kill-ring=, =consult-yank-pop=: Enhanced version of
   =yank= and =yank-pop= which allows selecting from the kill-ring. The selected
   text previewed as overlay in the buffer. There exists also
   =consult-yank-replace= which replaces the recently yanked text with a string
   selected from the =kill-ring=.
