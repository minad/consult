...
='preview=). In its simplest form supporting live preview, it looks something like
this:
...
Note that depending on how expensive the ='preview= logic is, you may wish to take
