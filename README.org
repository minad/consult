...
#+html: <a href="http://elpa.gnu.org/packages/consult.html"><img alt="GNU ELPA" src="https://img.shields.io/badge/GNU%20ELPA-consult-bb3955"/></a>
...
Consult can be installed from [[http://elpa.gnu.org/packages/consult.html][ELPA]] or [[https://melpa.org/][MELPA]] via the Emacs built-in package
