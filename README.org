...
** Editing
 ...
 - =consult-keep-lines=: Replacement for =keep/flush-lines=
   ...
   completion filtering as during =completing-read=. If the first character is
   "!", the filter matches the complement.
 - =consult-hide-lines=: Temporarily hide lines by filtering them using the current
   ...
   lines again. If the first character is "!", the filter matches the
