...
=consult-line=, which resembles [[https://github.com/abo-abo/swiper#swiper][Swiper]] or [[https://github.com/emacsorphanage/helm-swoop][Helm-Swoop]]. Some of the offered
commands are greatly enhanced versions of existing Emacs commands. For example
...
** Multiple sources
  ...
  If you use org, you can simulate =org-switchb= defining a source
  containing only your org buffers:
  #+begin_src elisp
  (add-to-list 'consult-buffer-sources
               (list :name     "Org"
                     :narrow   ?o
