...
kept to a minimum. The ability of Consult to work well with arbitrary completion
systems is the main advantage over other related packages. This property allows
Consult to fit well into existing setups and it helps you to create a full
completion environment out of small and independent components.
