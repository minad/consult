...
** Miscellaneous
 ...
 - =consult-completion-in-region=: This function can be set as
   ...
   UI is used. Furthermore you may prefer to see the completions directly in the
   buffer as a small popup. In that case you can either use the [[https://github.com/minad/corfu][Corfu]] or the
