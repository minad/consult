...
1. Check first that *all the relevant packages are updated to the newest version*. This
   includes Selectrum, Icomplete-vertical, Marginalia, Embark, Orderless and
