...
- =consult-info=: Full text search through info pages. You may want to create your
  own commands which search through a predefined set of info pages, for example:
